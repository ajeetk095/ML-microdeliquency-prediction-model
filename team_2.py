...
#Team Members
#Ajeet Kumar – Order ID.. 277487
#Amit Wankhede – Order ID ..251444
#Devansh Mishra – Order ID ..227840
#Harsh Dhar Dubey – Order ID..227797
...
train = pd.read_csv('Micro_delinquency_train_test_dataset_v2.csv', index_col=0)
# you need to enter scoring dataset as (test.csv) and it must contain the column 'label'
test = pd.read_csv('Micro_delinquency_train_test_dataset_v2.csv', index_col=0)
...
#OUTPUT:-
#MODEL-9: Accuracy of Stochastic Gradient Descent :
...
#OUTPUT:-
#MODEL-10: Accuracy of GradientBoostingClassifier :
'''
